...
posicao_braco P1 = {.servo1 = 0};
posicao_braco P2 = {.servo2 = 150};
posicao_braco P3 = {.servo3 = 115};
posicao_braco P4 = { .servo4 = 55};
posicao_braco P5 = {.servo1 = 95};
posicao_braco P6 = {.servo2 = 60};
posicao_braco P7 = {.servo2 = 95};
posicao_braco P8 = {.servo3 = 55};
posicao_braco P9 = {.servo4 = 35};
posicao_braco P10 = { .servo3 = 45};
